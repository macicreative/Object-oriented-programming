...
int main()
{
    ...
    if(t.pozovi("12-345")) {
        cout << "Broj 12-345 uspesno pozvao broj 22-333." << endl;
    } else {
        cout << "Broj 12-345 neuspesno pozvao broj 22-333." << endl;
    }
    ...
    TelefonGen2 tg, tg1("111-222", 128, 1000 );
    ...
    TelefonGen3 tgg, tgg1("061666999", 2, 200 );
